<template>
      ...
      <div class="content">
        ...
        <div class="signin-container">
          ...
          <div class="course-cards-container">
            <div v-for="course in courses" :key="course.id" class="course-cards" @click="handleCourseSelection(course)">
  ...
  .content {
    display: flex;
    justify-content: space-between; /* Neu: Platz zwischen den beiden Container */
  }
  ...
  .course-cards {
    ...
    margin-bottom: 10px;
    border-radius: 10px;
    position: relative; /* Neu: Position relativ für die Überlagerung */
  }
